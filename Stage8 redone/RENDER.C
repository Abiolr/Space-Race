...
void render_asteroids(UINT8 *base, Model *model)
{
    ...
    for (i = 0; i < MAX_ASTEROIDS; i += 1) {
        ...
        if (model->asteroid[i].delta_x == 2){
            plot_bitmap_8(base,model->asteroid[i].prev_x - (model->asteroid[i].delta_x * 2), model->asteroid[i].cur_y, black_8, 8);
        }
        plot_bitmap_8(base, model->asteroid[i].prev_x, model->asteroid[i].cur_y, black_8, 8);
...
{
    plot_bitmap_32(base, spaceship->cur_x, spaceship->prev_y, black_32, 32);
...
void render_hearts(UINT16 *base, const Model *model)
{
    switch (model->lives) {
        case 3:
            plot_bitmap_16(base, 610, HEART_ROW, heart_bitmap, HEART_HEIGHT);
            plot_bitmap_16(base, 600, HEART_ROW, heart_bitmap, HEART_HEIGHT);
            plot_bitmap_16(base, 580, HEART_ROW, heart_bitmap, HEART_HEIGHT);
            break;
        case 2:
            plot_bitmap_16(base, 610, HEART_ROW, heart_bitmap, HEART_HEIGHT);
            plot_bitmap_16(base, 600, HEART_ROW, heart_bitmap, HEART_HEIGHT);
            plot_bitmap_16(base, 580, HEART_ROW, black_16, 16);
            break;
        case 1:
            plot_bitmap_16(base, 610, HEART_ROW, heart_bitmap, HEART_HEIGHT);
            plot_bitmap_16(base, 600, HEART_ROW, black_16, 16);
            plot_bitmap_16(base, 580, HEART_ROW, black_16, 16);
            break;
        case 0:
            plot_bitmap_16(base, 610, HEART_ROW, black_16, 16);
            plot_bitmap_16(base, 600, HEART_ROW, black_16, 16);
            plot_bitmap_16(base, 580, HEART_ROW, black_16, 16);
    }
}
...
void render_score(UINT32 *base, const Model *model)
{
    ...
    plot_bitmap_32(base, FIRST_DIGIT, SCORE_ROW, black_32, 32);
    plot_bitmap_32(base, SECOND_DIGIT, SCORE_ROW, black_32, 32);
    plot_bitmap_32(base, THIRD_DIGIT, SCORE_ROW, black_32, 32);
...
void render_splash_screen(UINT32 *base){
    plot_bitmap_large(base, 0, 0, splash_screen_bitmap);
}
