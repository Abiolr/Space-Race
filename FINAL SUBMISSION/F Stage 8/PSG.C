...
* COMP 2659 PSG File
* 
* Purpose: To interface with the Programmable Sound Generator (PSG) chip for sound 
*          generation, including tone, volume, noise, and envelope control.
 ...
 * Function: write_psg
 * ---------------------
 * Writes a value to a specified PSG register.
 *
 * Parameters:
 *   reg: The PSG register to write to (0-15).
 *   val: The value to write (0-255).
 */
 ...
 * Function: read_psg
 * --------------------
 * Reads the current value of a specified PSG register.
 *
 * Parameters:
 *   reg: The PSG register to read from (0-15).
 *
 * Returns:
 *   The value stored in the specified PSG register.
 */
 ...
 * Function: set_tone
 * -------------------
 * Sets the tone frequency for a specific channel.
 *
 * Parameters:
 *   channel: The PSG channel (A, B, or C).
 *   tuning: The 12-bit tone frequency value.
 */
 ...
 * Function: set_volume
 * ----------------------
 * Sets the volume level for a specific channel.
 *
 * Parameters:
 *   channel: The PSG channel (A, B, or C).
 *   vol: The volume level (0-31).
 */
 ...
 * Function: set_noise
 * ---------------------
 * Sets the noise frequency for the PSG.
 *
 * Parameters:
 *   tuning: The noise frequency value (0-31).
 */
 ...
 * ------------------------
 * Sets the envelope shape and sustain duration for the PSG.
 *
 * Parameters:
 *   shape: The envelope shape value (0-15).
 ...
 * --------------------------
 * Enables or disables tone and noise for a specific channel.
 *
 * Parameters:
 *   channel: The PSG channel (A, B, or C).
 *   tone_on: 1 to enable tone, 0 to disable.
 *   noise_on: 1 to enable noise, 0 to disable.
 */
 ...
 * Function: stop_sound
 * ----------------------
 * Stops all sound output by resetting all PSG settings.
 */
void stop_sound()
{
    ...
    /*disable noise bits*/
    write_psg(NOISE_FREQ_REG, 0);

    /*disable envelope bits*/
    write_psg(ENV_FINE, 0);
    write_psg(ENV_ROUGH, 0);
    write_psg(ENV_SHAPE_CONTROL, 0);
